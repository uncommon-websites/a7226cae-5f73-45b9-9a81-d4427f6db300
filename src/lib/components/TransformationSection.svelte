    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mb-20">
            <h2 class="text-4xl md:text-5xl font-serif text-gray-900 leading-tight max-w-4xl">
                The middle market has been operating blind. <span class="font-semibold">Synply brings clarity to syndicated lending.</span>
            </h2>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative">
                <div class="relative rounded-lg overflow-hidden shadow-2xl bg-gray-900 aspect-[4/3]">
                    <img 
                        src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=2072&auto=format&fit=crop" 
                    ...
                    <div class="absolute inset-0 flex items-center justify-center p-8">
                        <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <span class="font-medium text-gray-900">Deal Comps</span>
                            </div>
                            <div class="space-y-2">
            ...
            <div class="space-y-12">
                <h3 class="text-2xl font-serif text-gray-900">
                    A Single Source of Truth <br/> for Syndicated Lending
                </h3>

                <div class="space-y-8">
                    {#each [
                        { id: '01', title: 'Structured, anonymized comps', icon: Database },
                        { id: '02', title: 'Defensible pricing benchmarks', icon: Search },
                        { id: '03', title: 'Market intelligence at your fingertips', icon: Settings },
                        { id: '04', title: 'Built for middle market deals', icon: FileText }
                    ] as feature}
